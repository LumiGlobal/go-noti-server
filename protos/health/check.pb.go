...
const file_check_proto_rawDesc = "" +
	"\n" +
	"\vcheck.proto\x12\x06health\"\x14\n" +
	"\x12HealthCheckRequest\"/\n" +
	"\x13HealthCheckResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2S\n" +
	"\rHealthService\x12B\n" +
	"\x05Check\x12\x1a.health.HealthCheckRequest\x1a\x1b.health.HealthCheckResponse\"\x00B\x17Z\x15go-noti-server/healthb\x06proto3"
